...
import { validateAuthKeyInDatabase } from '@/docs/lib/database';

// Mini app reward configuration
const MINI_APP_COOLDOWN_HOURS = 6;
const MINI_APP_REWARD_CLAIMS = 2;
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Check if user can claim mini app reward (6-hour cooldown)
    ...
    // Grant mini app reward (2 additional gift box claims)
