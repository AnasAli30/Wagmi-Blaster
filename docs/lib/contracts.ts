...
export const TOKEN_REWARD_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      { "internalType": "uint256", "name": "gamesRemaining", "type": "uint256" },
      { "internalType": "uint256", "name": "periodStartTime", "type": "uint256" },
      { "internalType": "uint256", "name": "periodEndTime", "type": "uint256" },
